    ...
    return(
        <div {...classes()}>
            <div {...classes('content')}>
                ...
                <p {...classes('content-bio')}>Software QA analyst and freelance FrontEnd-Engineer, I am focused responsive and modern design while considering user experience.</p>
            </div>
            <div {...classes('contact')}>
